...
void BFTokenizeFunction(bf_tokenizer* Tokenizer)
{
    ...
    CurrentFunction->RootScope.Lines = (bf_token**)kmalloc(sizeof(bf_token*));
    ...
    while (Tokenizer->At < NextMatchingBr)
    {
        ...
        bf_token** NewLines = (bf_token**)kmalloc(sizeof(bf_token*) * (CurrentFunction->RootScope.LineCount + 1));
        kmemcpy(NewLines, CurrentFunction->RootScope.Lines, sizeof(bf_token*) * CurrentFunction->RootScope.LineCount);
        kfree(CurrentFunction->RootScope.Lines);
